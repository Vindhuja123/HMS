				...
				<div class="box-register">
					<form name="registration" id="registration"  method="post">
						<fieldset>
							...
							<div class="form-group form-actions has-error">
								<span class="input-icon">
									<input type="password" class="form-control password" name="password" placeholder="Password" aria-required="true" aria-invalid="true" aria-describedby="password-error">
